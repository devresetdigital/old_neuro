window['fireResetPixel'] = function(pageUrl) {
    ...
    insertPixel('https://meta.resetdigital.co/smart?px={REPLACEPX}&tp=gif&k='+encodeURIComponent(meta_keywords)+'&t='+encodeURIComponent(meta_title)+'&d='+encodeURIComponent(meta_description)+'&email='+encodeURIComponent(meta_uemail)+'&purl='+encodeURIComponent(docLocation))
    insertPixel('https://bpi.rtactivate.com/tag/?id=20784&user_id={REPLACEPUID}');
    insertPixel('https://x.bidswitch.net/sync?dsp_id=447&user_id={REPLACEPUID}&expires=90');
    insertPixel('https://x.bidswitch.net/sync?ssp=resetdigital&user_id={REPLACEPUID}&expires=90');
}
