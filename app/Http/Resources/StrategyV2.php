...
class StrategyV2 extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $devices_names = array('','Windows Computer','Apple Computer','iPad','iPhone','iPod','Apple Device','Android Phone','Android Tablet','Other','Connected TV');
        $oss_names = array('','windows 7', 'windows 8', 'windows 10', 'macos','linux', 'android', 'ios','other','rokuos','tizen');
        ...
        //INC EXC
        if($ipl>0){ $iplists_incexc = $slincexc; } else { $iplists_incexc = 3;}
        ...
        $zplincexc=3;
        foreach ($this->StrategiesZiplist as $val){
            $zpl++;
        ...
        $isps = array_map('intval',explode(",",$this->StrategiesTechnologiesIsp["isp_id"]));

        $selected_segments = explode(",",$this->StrategiesSegment["segment_id"]);
        //$nsegments = count($selected_segments);
        if(count($selected_segments)==1 && $selected_segments[0]==""){
        ...
        return [
          ...
          //  $this->mergeWhen($cities[0]!="", [
            ...
            "pmps" => ["inc_exc"=> $pmps_inc_exc, "data"=>$pmps],
            ...
            "isps" => ["inc_exc"=> (count($isps)==0 || $isps[0]==0 || $isps[0]=="")? 3 : 1,"data"=> $isps[0]==0 ? [] : $isps],
            ...
            "custom_datas" => ["inc_exc"=> (count($custom_datas)==0 || $custom_datas[0]==0 || $custom_datas[0]=="")? 3 : 1,"data" => $custom_datas[0]==0 ? [] : $custom_datas],
