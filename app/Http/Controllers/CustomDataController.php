...
use App\CustomData;
use App\Http\Resources\CustomData as CustomDataResource;
...
class CustomDataController extends Controller
{
    ...
    {
        $models = CustomData::select('id', 'updated_at')->get();
        $reponse = []; 
    ...
    public function show($id)
    {
        ...
        $custom_data = CustomData::find($id);
        ...
        return new CustomDataResource($custom_data);
    }
