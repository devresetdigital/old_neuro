...
class ConceptController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if ($search->value) {
                ...
                $query->orWhereHas('Advertiser', function($q)  use ($search_value) {
    ...
    public function edit(Request $request, $id)
    {
        ...
        $concept->load('Creatives', 'Strategies', 'Strategies.Campaign');
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','concept','logged_user','organization_advertisers'));
    }
    ...
    public function export($id){
        ...
        $creatives = Creative::where('concept_id', $id)->get();

        foreach ( $creatives as $creative) {
            $creative = Creative::getDataToExport($creative->id);
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','logged_user','organization_advertisers'));
    }
    ...
    public function update_order(Request $request)
    {
      ...
      /**
     * clones a concept and redirect to the list
     */
    public function clone($id)
    {
        try {
            DB::beginTransaction();
            $concept =  Concept::find(intval($id));

            $clone = CloneHelper::cloneConcept($concept);
            if($clone['status']){
                DB::commit();
