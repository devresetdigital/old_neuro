...
class CustomdatasController extends VoyagerBaseController
{
...
//***************************************
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            if(!$request->has('file') || $request->input('file')=='[]'){
                ...
                $request->merge([
                    'file' => UploaderHelper::formatData($request->input('file'),$slug,$data->file)
                ]);
            }
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->has('_validate')) {
            ...
            //format data. replace it into request and move files to the correct folder
            $request->merge([
                'file' => UploaderHelper::formatData($request->input('file'),$slug)
            ]);
