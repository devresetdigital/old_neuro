...
class PixelController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        if(Auth::user()->role_id == 1){
            ...
            $organizations = Organization::find(Auth::user()->organization_id);
        }
        ...
        return Voyager::view($view, compact('dataType','organizations', 'dataTypeContent', 'isModelTranslatable'));
    }
