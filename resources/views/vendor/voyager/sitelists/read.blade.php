            ...
            <div class="col-md-12">
                ...
                <div class="card " style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        @endphp
                        <div class="panel-body col-sm-2" style="padding-top:0;">
                        <h3 class="panel-title" style="padding: 20px 30px 20px 0;">{{ $row->display_name }}</h3>
                        ...
                        <div id="collapseOne" class="collapse in" aria-labelledby="headingOne" data-parent="#accordion">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach($dataTypeContent['strategies'] as $strategy)
                                        <tr>
                                            ...
                                            <td>{{ substr($strategy['date_start'],0,10)}}</td>
                                            <td>{{ substr($strategy['date_end'],0,10)}}</td>
                                            <td><a href="/admin/campaigns/{{$strategy['Campaign']['id']}}/edit" target="_blank" rel="noopener noreferrer">{{$strategy['Campaign']['id']}}</a>  - {{$strategy['Campaign']['name']}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
