                          ...
                          <!--  <div class="form-group">
                                ...
                                @if(isset($dataTypeContent->id))
                                    @if (Auth::user()->hasRole('admin'))
                                        <div class="form-group">
                                            <label for="locale">{{ __('user.organization') }}</label>
                                            <select class="form-control select2" id="locale" name="organization_id">
                                            <option value="">{{ __('generic.none') }}</option>
                                                @foreach ($organizations as $organization)
                                                    <option value="{{ $organization->id }}"
                                                            {{ ($dataTypeContent->organization_id == $organization->id ? 'selected' : '') }}>{{  $organization->name  }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        @else
                                        <div class="form-group">
                                            <label for="locale">{{ __('user.organization') }}</label>
                                            <select disabled="disabled" class="form-control select2" id="locale" name="organization_id">
                                            <option value="">{{ __('generic.none') }}</option>
                                                @foreach ($organizations as $organization)
                                                    <option value="{{ $organization->id }}"
                                                            {{ ($dataTypeContent->organization_id == $organization->id ? 'selected' : '') }}>{{  $organization->name  }}</option>
