                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @else
                                    <div class="form-group @if($row->type == 'hidden') hidden @endif col-md-{{ $display_options->width or 12 }}" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                        {{ $row->slugify }}
                                        @if(isset($_GET["bulk"]) && $row->field == "geolocation")
                                                <label for="name">Bulk VWI File</label>
                                        ...
                                        @else
                                            @if($row->field == "geolocation")
                                                ...
                                                <script>
                                                    class GoogleMapPage {
                                                        ...
                                                        initMap() {
                                                            ...
                                                            @if($dataTypeContent->geolocation!="")
                                                            this.loadOverlays();
                                                            @endif
                                                            // this.drawSelected();
                                                        ...
                                                        addSaveButton() {
                                                            ...
                                                            this.form.saveElement.addEventListener('click', () => {
                                                                ...
                                                                var x = document.getElementsByName("geolocation");
                                                                var i;
                                                                for (i = 0; i < x.length; i++) {
                                                                    x[i].value = JSON.stringify(values, undefined, 4);
                                                                }
                                                        ...
                                                        readOverlaysData() {
                                                            return JSON.parse(`{!! htmlspecialchars_decode($dataTypeContent->geolocation)  !!}`);
                                                        }
                                                ...
                                                <div style="width: 100%; height: 600px">
                                                    ...
                                                    <button id="save" type="button" class="btn btn-light" data-toggle="modal" data-target="#saveModal">
