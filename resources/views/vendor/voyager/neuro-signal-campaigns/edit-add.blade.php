                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @php
                                    if($row->field == 'rsn_signal_campaign_belongsto_organization_relationship' && Auth::user()->role->id !=1){
                                        continue;
                                    }
                                ...
                                @if($options == '' || !property_exists($options, 'roles') || in_array(Auth::user()->role->id, $options->roles)) 
