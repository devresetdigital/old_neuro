...
<ol class="breadcrumb hidden-xs">
    ...
    <li class="active"><a href="#">Audience Report</a></li>
</ol>
    ...
    <div class="page-content compass container-fluid">
        <ul class="nav nav-tabs">
            ...
            @if(str_contains($_SERVER['SERVER_NAME'], 'inspire.com'))
                ...
                <li ><a href='/admin/strategies/reach_frequency/{{ $id }}'><i class="voyager-activity"></i>Reach & Frecuency</a></li>
                @endif
            @else
            <li ><a href='/admin/strategies/reach_frequency/{{ $id }}'><i class="voyager-activity"></i>Reach & Frecuency</a></li>
            @endif
...
function setHrefLink(Id, type, context, search){
        ...
        $("#"+Id).attr('href','/api/exports/pi?context='+context+'&type='+type+'&strategy_id={{$id}}&campaign_id={{$campaign_id}}&search='+search_str);
    }
