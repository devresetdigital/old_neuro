                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a data-id="{{$idprefixed}}" onClick="showPreview({{$idprefixed}})" href="#">Preview</a></li>
...
@section('javascript')
    ...
    <script>
        ...
        const clone = (id)=> {
            ...
            $(window).attr('location','/admin/cloneStrategies/'+id);
            }else{
                return false;
            }
        }
        ...
        const showPreview = (id) => {
            $('#preview_modal').find('iframe').attr('src','http://mapp.resetdigital.co/multipreview/?cid='+id);
