...
<ol class="breadcrumb hidden-xs">
    ...
    <li class="active"><a href="#">Creports</a>
                                </li>
</ol>
@stop
@section('content')
        ...
        <ul class="nav nav-tabs">
            ...
            @if(str_contains($_SERVER['SERVER_NAME'], 'inspire.com'))
                @if(auth()->user()->role_id == 1 || auth()->user()->role_id == 5)
                    <li ><a href='/admin/strategies/reach_frequency/{{ $idprefixed }}'><i class="voyager-activity"></i>Reach & Frecuency</a></li>
                @endif
            @else
                <li ><a href='/admin/strategies/reach_frequency/{{ $idprefixed }}'><i class="voyager-activity"></i>Reach & Frecuency</a></li>
            @endif
            <li><a href='/admin/strategies/special_reports/{{ $idprefixed }}' ><i class="voyager-list"></i>Audience Report</a></li>
        </ul>
            ...
            $('#'+id+'_dataTable').DataTable({
                ...
                "ajax": {
                    ...
                    "data": {
                        ...
                        'filters' : 'advcamps_3={{ $_GET["campaign_id"]  }}'+'&concreats='+fconcepts+fcreatives+'&channeldomains='+fdomains+'&countryisps='+fcountries+'&regioncities='+fregions,
                        'addvast' : addvast
                    }
                },
        ...
        window.onload = function() {
            ...
            $(document).ready(function() {
                ...
                $('#dataTable').DataTable({
                    ...
                    "ajax": {
                        ...
                        "data": {
                            ...
                            'uid' :  '{{ isset($user_id) ? $user_id : 0  }}',
                            'urole' :  '{{ isset($user_role) ? $user_role : 0  }}',
                            'filters' : 'advcamps_3={{ $_GET["campaign_id"]  }}'
                        }
                    },
                    order: [[ 0, "asc" ]],
                    columns: [
                ...
                $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
                    ...
                    document.location.href="/admin/strategies/reports/{{$id}}?from="+reportStartDate+"&until="+reportUntilDate+'&campaign_id={{ isset($_GET["campaign_id"]) ? $_GET["campaign_id"] : ''  }}';
