            ...
            <div class="panel">
                <div style="width: 100%; padding: 20px;">
                    <ul class="nav nav-tabs">
                        <li class="active">
                            <a data-toggle="tab" href="#custom">Attribution Report</a>
                        </li>
                        <h4 style="padding-left: 10em;"><!--Last Update: {{$pixel->last_update}}--></h4>
                    </ul>
                                ...
                                <div class="panel panel-primary panel-bordered">
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                <label>Type</label>
                                                <select class="form-control select2" name="type" id="type" multiple>
                                                    <option value="IMP">Impresions</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input class="form-control bootstrap-tagsinput tagsinput" name="campaigns" id="campaigns" >
                                            </div>
                                            
                                            <div class="col-md-4 form-group">
                                                <label>Strategy</label>
                                                <input class="form-control bootstrap-tagsinput tagsinput" name="strategies" id="strategies" >
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label>Creative</label>
                                                <input class="form-control bootstrap-tagsinput tagsinput" name="creatives" id="creatives" >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4 form-group">
...
function updateExportLink(){
        ...
        $("#exportcsv").attr('href','/api/exports/pixel_conversion?'+query);
        ...
        function genDatatable(){
            ...
            let strategies = $('#strategies').val();
            let creatives = $('#creatives').val();
            ...
            html += `
                            <th><label class="capitalize">User Conversions</label></th>
                            <th><label class="capitalize">Ip Conversions</label></th>
                            <th><label class="capitalize">User Agent Conversions</label></th>
                        </tr>
                    </thead>
                </table>            
            `;
            ...
            let ajaxUrl = '/api/pixel_conversion_report_table';
        ...
        function loadChart(){
            ...
            $.post("/api/pixel_conversion_report",
                {
                    countries :  countries,
                    regions : regions ,
                    cities :  cities,
                ...
                function(data){
                    ...
                    $.each(data, function( index, value ) {
                        ...
                        values_user.push(value[0]);
                        values_ip.push(value[1]);
                        values_agent.push(value[2]);
                     });
            
           
                    if( Math.max.apply(null, values_user)==0) {
                        var chartsuggestedMax = Math.max.apply(null, values_user);
                    } else {
                        ...
                        data: {
                            datasets: [
                                ...
                                },
                                {
                                    ...
                                    data: values_user,
                                    backgroundColor: "rgba(28, 134, 191,0.4)",
                                    borderColor: "rgba(18, 124, 191,0.7)",
                                    borderWidth: .6
                                },
                                {
                                    label: 'User Agents',
                                    yAxisID: 'IMP',
                                    data: values_agent,
                                    backgroundColor: "rgba(28, 134, 151,0.4)",
                                    borderColor: "rgba(18, 132, 151,0.7)",
                                    borderWidth: .6
                                }
                            ],
                            labels: labels
