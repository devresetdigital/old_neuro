            ...
            <div class="panel">
                ...
                <div class="page-content settings container-fluid">
                    <ul class="nav nav-tabs">
                        ...
                        @endforeach
                             <li @if($group == $active) class="active" @endif>
                                <a data-toggle="tab" href="#eventer">Eventer statuses</a>
                            </li>
                            <li @if($group == $active) class="active" @endif>
                                <a data-toggle="tab" href="#bidders">Bidders statuses</a>
                            </li>
                            <li @if($group == $active) class="active" @endif>
                                <a data-toggle="tab" href="#api">Api statuses</a>
                            </li>
                    </ul>
                    <div class="tab-content">
                        ...
                        @endforeach
                        <div id="eventer" class="tab-pane fade in @if($group == $active) active @endif"><iframe src="/eventerstatus_v1.0" title="description"></iframe></div>
                        <div id="bidders" class="tab-pane fade in @if($group == $active) active @endif"><iframe src="/bidderstatus_v2.2" title="description"></iframe></div>
                        <div id="api" class="tab-pane fade in @if($group == $active) active @endif"><iframe src="/panelstatus" title="description"></iframe></div>
                    </div>
                </div>
