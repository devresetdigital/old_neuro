            ...
            <div class="col-md-12">
                ...
                <div id="accordion">
                    <div class="card">
                        ...
                        <a style="position: absolute;top: 0;right: 1em;" href="/admin/lineardata/create?linear_id={{$dataTypeContent->getKey()}}" class="btn btn-small btn-success btn-add-new">
                            ...
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$date['id']}}</td>
                                            <td>{{substr($date['date'],0,10 )}}</td>
                                            <td>
                                                <a  href="/admin/lineardata/{{$date['id']}}/edit" class="btn btn-small btn-info btn-edit">
                                                    <span>{{ __('voyager::generic.edit') }}</span>
                                                </a>
                                                <a  href="/admin/lineardata/remove/{{$date['id']}}"  class="btn btn-small btn-danger btn-delete">
