    ...
    <div class="content" style="margin-left: 3.5em; margin-bottom: -10px">
        <header class="page-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h1 class="separator" style="font-size: 22px;">Cognitive Resonance Campaigns</h1>
                </div>
            </div>
        </header>
    </div>
                    ...
                    <div class="card-body p-0">
                        <div class="row m-0">
                            <div class="col-md-12">
                                <div class="card-body">
                                    <div class="col-sm-12">
                                        <label>Campaigns</label><a href="/admin/rsn_new" class="btn btn-sm pull-right btn-primary view">Add New</a>
                                        <div class="card " style="overflow: unset; min-height: 8em;  margin-top: 2em;">
                                            <div class="card-body">
                                                <table id="camnpaignTable">
                                                    <thead>
                                                        <tr>
                                                            <th>Campaign</th>
                                                            <th>Actions</th>
                                                    ...
                                                    @php
                                                        ...
                                                        echo '<td><a href="/admin/X2_report" class="btn btn-sm btn-primary view">Report</a><a href="/admin/rsn_edit/'.$campaign["id"].'" class="btn btn-sm btn-primary edit">Edit</a><a href="/admin/rsn_delete/'.$campaign["id"].'" class="btn btn-sm btn-danger  delete">Delete</a></td>';
                                                        echo '</tr>';
                                                        }
                                                    @endphp
                                                    </tbody>
