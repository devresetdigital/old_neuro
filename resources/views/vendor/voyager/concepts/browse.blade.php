                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            <td>
                                                ...
                                                @elseif($row->type == 'text')
                                                    ...
                                                    @if ($row->field=='id')
                                                        <div class="readmore"> <a target="_blank" href="/admin/concepts/{{$data->id}}/edit">{{ mb_strlen( $data->{$row->field} ) > 200 ? mb_substr($data->{$row->field}, 0, 200) . ' ...' : $data->{$row->field} }}</a></div>
                                                    @else
                                        ...
                                        <td class="no-sort no-click actions text-right" id="bread-actions">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="/admin/concepts/{{$data->id}}/edit">Edit</a></li>
                                                    <li><a href="/admin/concepts/{{$data->id}}/export">Export</a></li>
...
@section('javascript')
    ...
    <script>
        const clone = (id)=> {
            if (confirm('Are you sure you want to clone this Concept an all its creatives?')){
            $(window).attr('location','/admin/cloneConcepts/'+id);
            }else{
                return false;
            }
        }
