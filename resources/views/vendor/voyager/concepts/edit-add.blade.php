            ...
            <div class="col-md-12">
                ...
                <div class="card">
                        ...
                        <table id="dataTable" class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach($concept['creatives'] as $creatives)
                                        <tr>
                                            <td><a href="/admin/creatives/{{$creatives['id']}}/edit" target="_blank">{{$creatives['id']}}</a></td>
                                            <td>
                                                @if($creatives['creative_type_id'] == 1)
                                                    <span class="label label-info">Display</span>
                                                @elseif($creatives['creative_type_id'] == 2)
                                                    <span class="label label-primary">Video</span>
                                                @else
                                                    <span class="label label-primary">{{$creatives['creative_type_id']}}</span>
                                                @endif
                                            </td>
                                            <td>{{$creatives['name']}}</td>
                                            <td>
                                                @if($creatives['status'])
                            ...
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><a href="/admin/strategies/{{$strategy['id']}}/edit" target="_blank">{{$strategy['id']}}</a></td>
                                            <td>{{$strategy['name']}}</td>
                                            <td>
                                                @if($strategy['status'])
                                                    <span class="label label-info">Active</span>
                                            ...
                                            @if($strategy['campaign'] != null)
                                            <td><a href="/admin/campaigns/{{$strategy['campaign']['id']}}/edit" target="_blank">{{$strategy['campaign']['id'] ." - ". $strategy['campaign']['name']}}</a></td>
                                            @else
                                                <td>Unassigned</td>
                                            @endif
                                            <td>{{$strategy['date_start']}}</td>
                                            <td>{{$strategy['date_end']}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
