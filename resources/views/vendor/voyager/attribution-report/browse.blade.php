                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>   <div class="readmore"> <a target="_blank" href="/admin/pixel_conversion?pixelid={{$data->id}}">{{$data->id}}</a></div></td>
                                        @foreach($dataType->browseRows as $row)
                                            <td>
                                                ...
                                                @elseif($row->type == 'text')
                                                    @if ($row->field=='id')
                                                        <div class="readmore"> <a target="_blank" href="/admin/pixel_conversion?pixelid={{$data->id}}">{{ mb_strlen( $data->{$row->field} ) > 200 ? mb_substr($data->{$row->field}, 0, 200) . ' ...' : $data->{$row->field} }}</a></div>
                                                    @else
                                        ...
                                        <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="/admin/pixel_conversion?pixelid={{$data->id}}">Reports</a></li>
