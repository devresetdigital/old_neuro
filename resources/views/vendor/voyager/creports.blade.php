...
@endphp
@php $idprefixed = $wlprefix+intval($_GET["campaign_id"]); @endphp
@section('css')
...
@section('content')
    <div class="page-content compass container-fluid">
        <ul class="nav nav-tabs">
            <li><a data-toggle="tab" href="#" onclick="document.location.href='/admin/campaigns/{{ $_GET["campaign_id"]  }}/edit'"><i class="voyager-book"></i> Summary</a></li>
            <li><a data-toggle="tab" onclick="document.location.href='/admin/strategies_campaign/{{ $_GET["campaign_id"]  }}'" href="#"><i class="voyager-lab"></i> Strategies</a></li>
            ...
            <li {!! 'class="active"' !!}><a data-toggle="tab" href="#reports"><i class="voyager-bar-chart"></i> Reports</a></li>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row clearfix">
                                                        <div class="col-md-4 form-group">
                                                            ...
                                                            @php
                                                            $idnotprefixed = $_GET["campaign_id"];
            ...
            window.onload = function() {
                ...
                $(document).ready(function() {
                    ...
                    $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
                        ...
                        document.location.href="/admin/creports?from="+reportStartDate+"&until="+reportUntilDate+'&campaign_id={{ isset($_GET["campaign_id"]) ? $idnotprefixed : ''  }}';
